...
public class MyCustomPlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        set.add(new FullyQualifiedJavaType(Annotation.Component.getClazz()));
        interfaze.addImportedTypes(set);
        //interfaze.addAnnotation(Annotation.Mapper.getAnnotation() + "()");
        interfaze.addAnnotation(Annotation.Mapper.getAnnotation());
        interfaze.addAnnotation(Annotation.Component.getAnnotation());
    ...
    public static void classAnnotation(TopLevelClass topLevelClass, String explain) {
        ...
        topLevelClass.addJavaDocLine(" *");
        topLevelClass.addJavaDocLine(" * @author lhfeiyu");
    ...
    public static void interfazeAnnotation(Interface interfaze, String explain) {
        ...
        interfaze.addJavaDocLine(" *");
        interfaze.addJavaDocLine(" * @author lhfeiyu");
